  ...
  opts = {
    ...
    mappings = {
      ...
      v = {
        ...
        -- Avante visual mode mappings
        ["<C-a>"] = { "<cmd>AvanteAsk<cr>", desc = "Ask Avante with selection" },
        ["<C-a>e"] = { "<cmd>AvanteEdit<cr>", desc = "Edit selection with Avante" },
        ["<C-a>r"] = { "<cmd>AvanteReplace<cr>", desc = "Replace with Avante" },
        ["D"] = {
          function()
