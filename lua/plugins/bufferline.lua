...
--- Overrides and customizations for bufferline.nvim
--- Relies on astrocommunity.bars-and-lines.bufferline-nvim for base setup
...
return {
  ...
  opts = {
    options = {
      mode = "buffers",
      numbers = "none",
      -- Use AstroCore buffer close handler for proper cleanup
      ...
      left_trunc_marker = "",
      right_trunc_marker = "",
      -- Offset for snacks picker to prevent overlap
      offsets = {
