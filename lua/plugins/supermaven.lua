...
return {
  ...
  optional = true,
  -- ignore_filetypes gates both the buffer sync (on_update) and the
  -- suggestion poll, so python buffers are never sent to the binary
  opts = { ignore_filetypes = { python = true } },
